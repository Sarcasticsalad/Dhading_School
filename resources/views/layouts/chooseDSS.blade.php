            ...
            <div class="flex flex-col gap-6 lg:flex-row lg:gap-3 xl:flex-row xl:gap-4">
                ...
                <div class="flex flex-col gap-5 2xl:gap-8 md:p-10 lg:p-6 xl:p-10 2xl:p-8 border-8 border-DDS-blue rounded-3xl w-[20rem] h-[19rem] sm:w-[28rem] sm:h-[16rem] md:w-[40rem] md:h-[23rem] lg:w-[30rem] lg:h-[20rem] xl:w-[39rem] xl:h-[20rem] 2xl:w-[30rem] 2xl:h-[20rem]">
                    <div class="flex flex-row justify-between">
                        <h1 class="font-arialBold font-bold text-DDS-blue text-2xl md:text-3xl lg:text-3xl 2xl:text-2xl">Essential Skills</h1>
                        <img src="{{ asset('pictures/skills-blue.png') }}" class="h-[2rem] sm:h-[1.8rem] md:h-[2rem] xl:h-[2.7rem] 2xl:h-[2rem]">
                    </div>
                    <div>
                ...
                <div class="flex flex-col gap-5 xl:gap-3 2xl:gap-8 md:p-10 lg:p-6 xl:p-10 2xl:p-8 bg-DDS-blue rounded-3xl border-8 border-DDS-blue w-[20rem] h-[19rem] sm:w-[28rem] sm:h-[16rem] md:w-[40rem] md:h-[23rem] lg:w-[30rem] lg:h-[20rem] xl:w-[39rem] xl:h-[20rem] 2xl:w-[30rem] 2xl:h-[20rem]">
                    ...
                    <div>
                        <p class="text-white font-arialRegular font-normal lg:text-normal text-justify">
                ...
                <div class="flex flex-col gap-6 lg:flex-row lg:gap-3 xl:flex-row xl:gap-4">
                    ...
                    <div class=" flex flex-col gap-5 2xl:gap-8 lg:p-6 xl:p-10 2xl:p-8 border-DDS-blue border-8 rounded-3xl w-[20rem] h-[19rem] sm:w-[28rem] sm:h-[16rem] md:w-[32rem] md:h-[20rem] lg:w-[30rem] lg:h-[20rem] lg:bg-DDS-blue xl:w-[39rem] xl:h-[20rem] 2xl:w-[30rem] 2xl:h-[20rem] ">
                        ...
                        <div>
                            <p class="text-white font-arialRegular font-normal lg:text-base text-justify">
                    ...
                    <div class=" flex flex-col gap-5 2xl:gap-8 lg:p-6 xl:p-10 2xl:p-8 rounded-3xl lg:border-DDS-blue w-[20rem] h-[19rem] sm:w-[28rem] sm:h-[16rem] md:w-[32rem] md:h-[20rem] lg:w-[30rem] lg:h-[20rem] lg:border-8 xl:w-[39rem] xl:h-[20rem] 2xl:w-[30rem] 2xl:h-[20rem]">
                        <div class="flex flex-row justify-between">
                            <h1 class="font-arialBold font-bold text-2xl md:text-3xl lg:text-3xl 2xl:text-2xl text-white lg:text-DDS-blue">Extra Curricular Activities</h1>
                            <img src="{{ asset('pictures/flask-blue.png') }}" class="h-[2.5rem] sm:h-[1.8rem] md:h-[2rem] xl:h-[2.7rem] 2xl:h-[2.3rem] hidden lg:block">
                        </div>
                        <div>
                            <p class= "text-black font-arialRegular font-normal lg:text-base  text-justify">
        ...
        <div class=" flex flex-col gap-6 sm:gap-8 md:gap-10 lg:gap-3 xl:gap-4">
            ...
            <div class="flex flex-col justify-center items-center gap-6 sm:gap-8 lg:flex-row lg:gap-3 xl:flex-row xl:gap-4">
                ...
                <div class="flex flex-col gap-5 p-5 sm:p-10 md:p-10 border-4 sm:border-8 border-DDS-blue rounded-3xl w-[18rem] sm:w-[28rem] md:w-[40rem]">
                    ...
                    <div>
                        <p class="font-arialRegular font-normal text-left text-base">
                ...
                <div class="flex flex-col gap-5 p-5 sm:p-10 md:p-10 bg-DDS-blue rounded-3xl border-4 sm:border-8 border-DDS-blue w-[18rem] sm:w-[28rem] sm:h-[31.5rem] md:w-[40rem] md:h-[23rem]">
                    ...
                    <div>
                        <p class="text-white font-arialRegular font-normal text-base text-left">
                ...
                <div class="flex flex-col gap-6 sm:gap-8 lg:flex-row lg:gap-3 xl:flex-row xl:gap-4">
                    ...
                    <div class=" flex flex-col gap-5 p-5 sm:p-10 md:p-10 border-DDS-blue  border-4 sm:border-8 rounded-3xl w-[18rem] sm:w-[28rem] md:w-[40rem] md:h-[23rem]">
                        ...
                        <div>
                            <p class="font-arialRegular text-base text-left">
