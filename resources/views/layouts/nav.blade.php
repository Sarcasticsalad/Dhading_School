<nav class="flex justify-between h-16 md:h-20 ">
         ...
         <div class="nav-links absolute bg-white px-5 top-[60%] lg:top-[50%] pb-8 pt-4 hidden  sm:px-8  md:px-10  lg:px-16 xl:static xl:block  2xl:block ">
                <div class="flex flex-col pt-1 gap-8 lg:flex-col lg:gap-8 lg:mr-8 xl:flex-row xl:justify-end xl:pr-3">
                    ...
                    <div class=" mt-2">
                        ...
                        <div class="absolute hidden bg-white w-64 " id="aboutUsDropdown">
