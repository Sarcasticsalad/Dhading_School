         ...
         <div class="nav-links flex items-center absolute hidden bg-white w-screen px-5 top-[100%] lg:top-[90%] pb-8 pt-4 sm:px-8  md:px-10 lg:px-16 lg:static lg:block  xl:block  2xl:block ">
                <div class="flex flex-col items-center lg:justify-end mt-1 gap-8 lg:flex-row lg:gap-4 lg:mr-8 xl:flex-row xl:justify-end xl:gap-8 w-full">
                    <div class=" flex items-center">
                        <a href="" id="aboutUsLink" class="font-arialBold font-bold text-gray-700 hover:text-DDS-blue px-4 py-2 lg:text-sm xl:text-base">About Us</a>
                        <div class="absolute hidden flex flex-col shadow-md shadow-black xl:border-2 border-DDS-blue bg-white w-40 h-[6.5rem] lg:mt-20 xl:mt-6  top-[69%] lg:top-[2%] xl:top-[69%] 2xl:top-[69%] rounded-md" id="aboutUsDropdown">
                            <a href="#whyDDS" class="block font-arialBold font-bold text-gray-700 hover:text-DDS-blue  lg:text-sm xl:text-base text-justify pl-6 py-1 border">Why DDS</a>
                            <a href="#Management" class="block font-arialBold font-bold text-gray-700 hover:text-DDS-blue  lg:text-sm xl:text-base text-justify pl-6 py-1 border">Management</a>
