<div class="flex flex-col mt-11 sm:mt-14 md:mt-16 lg:mt-28 2xl:mt-24 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-14 " id="Courses">
    ...
    <div class="flex flex-col gap-10 items-center md:hidden lg:block lg:flex lg:flex-row lg:justify-center lg:gap-20 xl:gap-28 2xl:gap-24 px-14">
        ...
        <div class="flex flex-row gap-10 lg:gap-14 xl:gap-28 2xl:gap-24">
            ...
            <div class="cursor-pointer">
                <div class="relative w-[8rem] h-[8rem] bg-shadow-blue rounded-lg sm:w-[16rem] sm:h-[16rem] lg:w-[10rem] lg:h-[10rem] xl:w-[11rem] xl:h-[11rem] 2xl:w-[12rem] 2xl:h-[12rem]">
                    <div class="absolute rounded-lg bottom-2 right-2 bg-Card-blue w-[8rem] h-[8rem] sm:w-[16rem] sm:h-[16rem] lg:w-[10rem] lg:h-[10rem] xl:w-[11rem] xl:h-[11rem] 2xl:w-[12rem] 2xl:h-[12rem]">
                        <div class="absolute w-full bottom-9 sm:bottom-28 lg:bottom-12 xl:bottom-14 2xl:bottom-16">
            ...
            <div class="cursor-pointer">
                <div class="relative w-[8rem] h-[8rem] bg-shadow-blue rounded-lg sm:w-[16rem] sm:h-[16rem] lg:w-[10rem] lg:h-[10rem] xl:w-[11rem] xl:h-[11rem] 2xl:w-[12rem] 2xl:h-[12rem]">
                    <div class="absolute rounded-lg bottom-2 right-2 bg-Card-blue w-[8rem] h-[8rem] sm:w-[16rem] sm:h-[16rem] lg:w-[10rem] lg:h-[10rem] xl:w-[11rem] xl:h-[11rem] 2xl:w-[12rem] 2xl:h-[12rem]">
                        <div class="absolute bottom-9 w-full sm:bottom-28 lg:bottom-12 xl:bottom-14 2xl:bottom-16">
       ...
       <div class="flex flex-row gap-10 lg:gap-14 xl:gap-28 2xl:gap-24">
        ...
        <div class="cursor-pointer">
            <div class="relative w-[8rem] h-[8rem] bg-shadow-blue rounded-lg sm:w-[16rem] sm:h-[16rem] lg:w-[10rem] lg:h-[10rem] xl:w-[11rem] xl:h-[11rem] 2xl:w-[12rem] 2xl:h-[12rem]">
                <div class="absolute rounded-lg bottom-2.5 right-2.5 bg-Card-blue w-[8rem] h-[8rem] sm:w-[16rem] sm:h-[16rem] lg:w-[10rem] lg:h-[10rem] xl:w-[11rem] xl:h-[11rem] 2xl:w-[12rem] 2xl:h-[12rem]">
                    <div class="absolute bottom-12 w-full sm:bottom-28 lg:bottom-16 xl:bottom-16 2xl:bottom-20">
